...
public class UIInventory : MonoBehaviour
{
    ...
    public GameObject inventoryWindow; // 이 스크립트가 달려있는 게임오브젝트의 게임오브젝트를 지칭
    public Transform slotPanel; // 이 스크립트가 달려있는 오브젝트의 트랜스폼 컴포넌트를 지칭
    ...
    public void SelectItem(int index)
    {
        ...
        // 모든 아이템에 스탯정보가 있는게 아니라서 일단 Empty로 초기화
        selectedItemStatName.text = string.Empty;
        selectedItemStatValue.text = string.Empty;
